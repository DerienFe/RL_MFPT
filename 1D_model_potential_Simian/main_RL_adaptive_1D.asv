...
C_g=[1:2:N];
std_g=[0:5:50];
action_space=meshgrid(C_g,std_g);
MDP = createMDP(nodes,action_space);
% https://uk.mathworks.com/help/reinforcement-learning/ug/create-custom-reinforcement-learning-environment-in-matlab.html
%env = rlFunctionEnv(ObservationInfo,ActionInfo,"myStepFunction","myResetFunction");
% MDP.T=get_biased_M; %implement this?
% MDP.R = mfpt(biased_M,i,end_state) implement?
lkretjlekr
