...
def count_transitions(b, numbins, lagtime, endpt=None, use_symmetry=False):
    """
...
class DHAM:
    ...
    def run(self, plot=False, adjust=True, biased=False, conversion=2E-13, use_symmetry=True):
        """
