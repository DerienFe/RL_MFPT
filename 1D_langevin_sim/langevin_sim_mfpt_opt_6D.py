...
def random_initial_bias6D(initial_position, num_gaussians):
    ...
    bdim4 = rng.uniform(initial_position[0] - 0.5,initial_position[0]+0.5,num_gaussians)
    bdim5 = rng.uniform(initial_position[0] - 0.5, initial_position[0]+0.5.num_gaussians)
    bdim6 = rng.uniform(initial_position[0] - 0.5, initial_position[0]+0.5.num_gaussians)
    cx = rng.uniform(1,5,num_gaussians)
    cy = rng.uniform(1,5,num_gaussians)
    cz = rng.uniform(1,5,num_gaussians)
    cdim4 = rng.uniform(1,5,num_gaussians)
    cdim5 = rng.uniform(1,5,num_gaussians)
    cdim6 = rng.uniform(1,5,num_gaussians)
    return np.concatenate((a,bx,by,bz,bdim4,bdim5,bdim6,cx,cy,cz,cdim4,cdim5,cdim6))
    ...
    #def simulate_once():
        ...
        while reach is None:
            ...
            if i_prop == 0:
                ...
                gaussian_params = random_initial_bias6D(initial_position = config.start_state, num_gaussians = config.num_gaussian)
